export const discoverRequest = (genre) => {
  fetch(
    `https://api.themoviedb.org/3/discover/movie?api_key=145d735794b8c35cc77b1dd1a86ea0dd&language=en-US&sort_by=popularity.desc&page=1&with_genres=${genre}`
  )
...
export const discoverRequestNew = async (genre, pageNum = 1) => {
  const linkHandler = () => {
    return genre == null ? "" : `&with_genres=${genre}`;
  };
  //await doesnt let the variable to create without async data;
  let response = await fetch(
    `https://api.themoviedb.org/3/discover/movie?api_key=145d735794b8c35cc77b1dd1a86ea0dd&language=en-US&sort_by=vote_average.desc&vote_count.gte=100&include_adult=false&primary_release_date.gte=1970-01-01&with_original_language=en&page=${pageNum}${linkHandler()}`
  );
...
//     let response = await fetch(`https://image.tmdb.org/t/p/original${imageName}`)
//     let image = response;
//     console.log(image)
// }
...
export const randomMovieRequest = async () => {
  ...
  let response = await fetch(
    `https://api.themoviedb.org/3/discover/movie?api_key=145d735794b8c35cc77b1dd1a86ea0dd&language=en-US&sort_by=popularity.desc&include_adult=false&with_original_language=en&page=${randomNum}`
  );
  let data = response.json();
  return data;
};
...
export const lastReleasedRequest = async () => {
  ...
  let response = await fetch(
    `https://api.themoviedb.org/3/discover/movie?api_key=145d735794b8c35cc77b1dd1a86ea0dd&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&release_date.lte=${date}&with_original_language=en`
  );
  let data = response.json();
  return data;
};
...
export const popularActorsRequest = async () => {
  ...
  let response = await fetch(
    `https://api.themoviedb.org/3/person/popular?api_key=145d735794b8c35cc77b1dd1a86ea0dd&language=en-US&page=${randomNum}`
  );

  //another way to get trending actor of the day
  // let response = await fetch(
  //   `https://api.themoviedb.org/3/trending/person/day?api_key=145d735794b8c35cc77b1dd1a86ea0dd`
  // );
  let data = response.json();
  return data;
};
...
export const specificMovieRequest = async (id) => {
  ...
  let infoResponse = await fetch(
    `https://api.themoviedb.org/3/movie/${id}?api_key=145d735794b8c35cc77b1dd1a86ea0dd&language=en-US`
  );
  ...
  let castRes = await fetch(
    `https://api.themoviedb.org/3/movie/${id}/credits?api_key=145d735794b8c35cc77b1dd1a86ea0dd&language=en-US`
  );
  if (castRes.ok) {
